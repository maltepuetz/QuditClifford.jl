...
full O(n^3) canonicalize and later ones do not; canonicalizing up front makes
that choice explicit instead of an artefact of sample ordering. The Stab-vs-
Destab canonicalize asymmetry is still measured, by `measure!/deterministic`.
"""
