...
@testset "Purity checks" begin
    @testset "Qubits (d=2)" begin
        ...
        stab_pure_comm = StabilizerTableau(2, 2, tab_pure; m=2, storephase=true)
        @test QuditClifford.is_commuting(stab_pure_comm)

        stab_pure_indep = StabilizerTableau(2, 2, tab_pure; m=2, storephase=true)
        @test QuditClifford.is_independent(stab_pure_indep)

        stab_pure = StabilizerTableau(2, 2, tab_pure; m=2, storephase=true)
        ...
        stab_noncomm = StabilizerTableau(2, 2, tab_noncomm; m=2, storephase=true)
        @test with_logger(NullLogger()) do
        ...
        stab_dep_indep = StabilizerTableau(2, 2, tab_dep; m=2, storephase=true)
        @test !QuditClifford.is_independent(stab_dep_indep)

        stab_dep = StabilizerTableau(2, 2, tab_dep; m=2, storephase=true)
    ...
    @testset "Qudits (d=3)" begin
        ...
        # Note: is_independent is destructive (it Gauss-Jordan reduces a view),
        # so use fresh tableaux for each property to keep tests isolated.
        stab_pure_comm = StabilizerTableau(3, 2, tab_pure; m=2, storephase=true)
        @test QuditClifford.is_commuting(stab_pure_comm)

        stab_pure_indep = StabilizerTableau(3, 2, tab_pure; m=2, storephase=true)
        @test QuditClifford.is_independent(stab_pure_indep)

        stab_pure = StabilizerTableau(3, 2, tab_pure; m=2, storephase=true)
        @test QuditClifford.is_pure(stab_pure)
        ...
        stab_noncomm = StabilizerTableau(3, 2, tab_noncomm; m=2, storephase=true)
        @test with_logger(NullLogger()) do
            !QuditClifford.is_pure(stab_noncomm)
        end
        ...
        stab_dep_indep = StabilizerTableau(3, 2, tab_dep; m=2, storephase=true)
        @test !QuditClifford.is_independent(stab_dep_indep)

        stab_dep = StabilizerTableau(3, 2, tab_dep; m=2, storephase=true)
        @test !QuditClifford.is_pure(stab_dep)
    end
end
